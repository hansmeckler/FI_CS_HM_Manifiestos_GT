    ...
    public class txtGenerationController : Controller
    {
        ...
        public ActionResult CreateTxtFile(FormCollection collection)
        {
            ...
            try
            {
                ...
                string code = Params.manifest_code;
                string emisor = Params.manifest_emisor;

                string mmnarc = "P" + code + seq_next;               
                /*switch (pais)
                {
                    case 1: mmnarc = "P49E" + seq_next; break;
                    case 15: mmnarc = "P18F" + seq_next; break;
                    case 32: mmnarc = "P84F" + seq_next; break;
                }*/

                var manifest = container_info.Select(a => a.manifest).FirstOrDefault();

                manifest = code + (DateTime.Now.Year).ToString().Substring(2, 2) + this._adminServices.pad0(mmnfst, 6);
                if (operation == 22)
                    myobj.Add("UNB+UNOA:2+" + emisor + "+" + dep(puerto_origen) + "+" + DateTime.Now.Year + DateTime.Now.ToString("MM") + DateTime.Now.ToString("dd") + ":" + DateTime.Now.Hour + DateTime.Now.Minute + "+" + mtrans + "+" + test);
                else
                    myobj.Add("UNB+UNOA:2+" + emisor + "+" + dep(puerto_desembarque) + "+" + DateTime.Now.Year + DateTime.Now.ToString("MM") + DateTime.Now.ToString("dd") + ":" + DateTime.Now.Hour + DateTime.Now.Minute + "+" + mtrans + "+" + test);
                ...
                switch (pais)
                {
                    ...
                    case 32: 
                        manifest = "84F" + (DateTime.Now.Year).ToString().Substring(2, 2) + this._adminServices.pad0(mmnfst, 6);
                ...
                */
                ...
                string recept = "01G" + "1" + this._adminServices.pad0(mmnfst.ToString(), 3);

                //myobj.Add("BGM+" + type + "+" + manifest + "+" + function);
                myobj.Add("BGM+" + type + "+" + manifest + this._adminServices.iif(type == 785, "", recept) + "+" + function);
                myobj.Add("RFF+" + this._adminServices.iif(type == 785, "AFB", "API") + this._adminServices.iif(moriginal != manifest && moriginal != "NA", ":" + moriginal, "" ));


                /*
                myobj.Add("BGM+" + "785" + "+" + manifest + "+" + function);
                myobj.Add("RFF+" + "AFB" + this._adminServices.iif(moriginal != manifest && moriginal != "NA", ":" + moriginal, ""));

                myobj.Add("BGM+" + "632" + "+" + manifest + "01G" + "1" + this._adminServices.pad0(mmnfst.ToString(), 3) + "+" + function);
                myobj.Add("RFF+" + "API" + this._adminServices.iif(moriginal != manifest && moriginal != "NA", ":" + moriginal, ""));
                */           

                myobj.Add("NAD+" + funcsend + "+" + emisor + "::9"); 

                /*
                switch (pais)
                {
                    case 1:     myobj.Add("NAD+" + funcsend + "+" + "7400000000421" + "::9"); break;
                    case 15:    myobj.Add("NAD+" + funcsend + "+" + "7400000001299" + "::9"); break;
                    case 32:    myobj.Add("NAD+" + funcsend + "+" + "7400000000421" + "::9"); break;
                }*/
