    ...
    public class txtGenerationController : Controller
    {
        ...
        public ActionResult CreateTxtFile(FormCollection collection)
        {
            ...
            try
            {
                ...
                Manifiesto.Data.Maritimo.MaritimoServices.parametros Params = Manifiesto.Data.Maritimo.MaritimoServices.EmpresaParametros(company, "", "MANIFEST");

                string code = Params.manifest_code;
    
                mmnarc = "E" + code + mtrans;
                //manifest = code + (DateTime.Now.Year).ToString().Substring(2, 2) + "01" + this._adminServices.pad0(mmnfst, 4);
                manifest = code + (DateTime.Now.Year).ToString().Substring(2, 2) + this._adminServices.pad0(mmnfst, 6);
                opcode = code;
                glnsender = Params.manifest_emisor;
                ...
                switch (company)
                {
                    ...
                    case "GTTLA":
                        mmnarc = "E84F" + mtrans;
                        manifest = "84F" + (DateTime.Now.Year).ToString().Substring(2, 2) + "01" + this._adminServices.pad0(mmnfst, 4);
                        opcode = "84F";
                        glnsender = "7400000000421";
                        break;
                }*/
                ...
                myobj.Add("RFF+" +  "AFB" + this._adminServices.iif(original != "", "+" + original, ":" + ""));

                myobj.Add("BGM+" + "632" + "+" + manifest + recept + "+" + function);
                myobj.Add("RFF+" + "API" + this._adminServices.iif(original != "", "+" + original, ":" + ""));
                */
