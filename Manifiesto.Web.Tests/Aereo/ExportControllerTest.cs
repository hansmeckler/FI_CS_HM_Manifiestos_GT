...
{
    /// <summary>
    /// Summary description for ExportControllerTest
    /// </summary>
    [TestClass]
    public class ExportControllerTest
    {
        ...
        public void Index_Return_NotNull()
        {
            ...
            mock.Setup(f => f.getGuiasExportList()).Returns(new List<guiasListViewModel>
            {
            ...
            var controller = new ExportController(mock.Object);
